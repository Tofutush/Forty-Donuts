...
function titleBox(targets) {
	let box = elt('div', {style: 'font-size:24px;border:10px solid #0cf;background-color:#fff;padding:5px;position:fixed;white-space:nowrap;filter:opacity(0);transition:filter .1s;z-index:12345;'});
